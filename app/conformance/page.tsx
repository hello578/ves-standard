...
export const metadata: Metadata = { title: "Conformance", description: "Current VES 1.2 conformance claims and the planned testing boundary.", alternates: { canonical: "/conformance" } }
export default function ConformancePage(){return <PageFrame eyebrow="Current position" title="Conformance programme in development" intro="VES 1.2 provides schemas and test vectors for implementation review. It does not currently operate a certification, seal or award programme." toc={[{id:"claims",label:"Current claims"},{id:"tests",label:"Future tests"},{id:"marks",label:"Marks"}]}>
  <h2 id="claims">What may be claimed now</h2><p>An implementation may state that it targets or has been structurally tested against a named VES 1.2 schema or profile, provided the version, test scope, date and limitations are stated. It must not imply endorsement by Veriscopic.</p><div className="callout">Recommended language: “Designed against the VES 1.2 Decision Envelope schema. This is an implementation statement, not certification by VES or Veriscopic.”</div>
  ...
  <p>Veriscopic reserves VES marks, formal conformance language and certification use. Public schema availability does not grant an implementation the right to imply certification, endorsement or organisational approval.</p>
  </PageFrame>}
