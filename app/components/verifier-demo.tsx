  ...
  return <div className="verifier-shell">
    ...
    <div className="verifier-grid">
      ...
      <div>
        ...
        {state.mode === "valid" && <section className="structural-result structural-result-valid" aria-live="polite"><p className="eyebrow">Structural result</p><h2>Structure valid</h2><p>The JSON conforms to the VES Decision Envelope 1.2 Draft schema.</p><div className="callout callout-warning"><strong>No VES result status has been determined.</strong> Structural validation alone cannot establish source integrity, provenance, business authority, temporal applicability or replayability.</div></section>}
